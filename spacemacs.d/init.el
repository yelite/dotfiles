...
layers configuration. You are free to put any user code."
  ...
  (setq TeX-view-program-list '(("PDF Viewer" "/Applications/Skim.app/Contents/SharedSupport/displayline -b -g -r %n %o %b")))
  ...
  (advice-add #'spacemacs//company-active-navigation
              :after (lambda (style)

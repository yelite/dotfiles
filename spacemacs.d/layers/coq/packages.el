  ...
  (use-package proof-site
    ...
    (progn
      (setq coq/proof-general-load-path
            (concat (configuration-layer//get-package-directory 'proof-general)
                    "generic"))
    ...
    (progn
      ...
      (spacemacs|define-transient-state proof-zen
        :title "Proof Transient State"
        :doc "\n[_[_/_]_] next/previous statement. \
[_,_] exits."
        :foreign-keys run
        :bindings
      ...
      (spacemacs/set-leader-keys-for-major-mode 'coq-mode
        ...
        "[" 'proof-undo-last-successful-command
        "." 'proof-goto-point
        "," 'spacemacs/proof-zen-transient-state/body
        ;; Layout
...
(defun coq/post-init-proof-general ()
